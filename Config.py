...
ShareDrivePath_mysore = r"\\D:\invoice\from" #mysore
...
#serverFileBackupPath_mysore = "D://THSABOT3SRVR//InvoiceBackups/"
serverFileBackupPath_mysore = os.path.join("THSABOT3SRVR", "InvoiceBackups")

#destination = "D://THSABOT3SRVR//InvoiceBackups/"
destination = os.path.join("THSABOT3SRVR", "InvoiceBackups")
